// src/components/UserComponents/Sidebar/Sidebar.jsx
    ...
    <aside className={`sidebar ${isOpen ? 'sidebar--open' : ''}`}>
      ...
      <nav>
        <ul className="sidebar__list">
          ...
          <li>
            <button className="sidebar__category-btn" onClick={toggleServices}>
              <span>الخدمات الرقمية</span>
              <svg className={`sidebar__chevron ${servicesOpen ? 'sidebar__chevron--open' : ''}`} width="16" height="16" viewBox="0 0 16 16">
